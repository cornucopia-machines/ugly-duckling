...
if(UD_GEN STREQUAL "")
    ...
    message("Building Ugly Duckling for target '${_ud_target}' (runtime MAC detection)")
...
list(APPEND SDKCONFIG_FILES "${CMAKE_CURRENT_LIST_DIR}/sdkconfig.${_ud_target}.defaults")
